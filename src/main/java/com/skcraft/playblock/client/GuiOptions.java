...
public class GuiOptions extends GuiScreen {
    ...
    public void initGui() {
        ...
        if (!mediaManager.isSupported()) {
            this.buttonList.add(installButton = new GuiButton(controlIndex++, left + 10, top + 145, xSize - 18, 20, "Install..."));
        }

        this.buttonList.add(closeButton = new GuiButton(controlIndex++, left + 10 + twoButtonWidth + 7, top + 170, twoButtonWidth, 20, "Done"));

        this.buttonList.add(openUrlButton = new GuiButton(controlIndex++, left + 10, top + 170, twoButtonWidth, 20, "Website..."));
    ...
    public void drawScreen(int mouseX, int mouseY, float par3) {
        ...
        String options = "PlayBlock Options";
