...
public class GuiQueue extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(addButton = new GuiButton(0, left + 215, top + 14, 25, 20, "Add"));
        buttonList.add(clearUriButton = new GuiButton(1, left + 195, top + 14, 17, 20, "X"));
        buttonList.add(removeButton = new GuiButton(2, left + 4, top + 130, 42, 20, "Add"));
        buttonList.add(clearButton = new GuiButton(3, left + 4, top + 100, 42, 20, "Clear"));
        removeButton.enabled = false;

        uriField = new GuiTextField(208, fontRendererObj, left + 35, top + 17, 157, fontRendererObj.FONT_HEIGHT + 5);
