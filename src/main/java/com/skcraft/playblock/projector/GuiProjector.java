...
public class GuiProjector extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(applyButton = new GuiButton(0, left + 160, top + 125, 80, 20, "Done"));

        this.buttonList.add(clearUriButton = new GuiButton(1, left + 220, top + 14, 17, 20, "X"));

        uriField = new GuiTextField(250, this.fontRendererObj, left + 60, top + 17, 157, this.fontRendererObj.FONT_HEIGHT + 5);
        initTextField(uriField, 100, uri);

        heightField = new GuiTextField(251, this.fontRendererObj, left + 130, top + 37, 50, this.fontRendererObj.FONT_HEIGHT + 5);
        initTextField(heightField, 10, Float.toString(projectorHeight));

        widthField = new GuiTextField(252, this.fontRendererObj, left + 60, top + 37, 50, this.fontRendererObj.FONT_HEIGHT + 5);
        initTextField(widthField, 10, Float.toString(projectorWidth));

        triggerRangeField = new GuiTextField(253, this.fontRendererObj, left + 60, top + 57, 50, this.fontRendererObj.FONT_HEIGHT + 5);
        initTextField(triggerRangeField, 10, Float.toString(triggerRange));

        fadeRangeField = new GuiTextField(254, this.fontRendererObj, left + 60, top + 77, 50, this.fontRendererObj.FONT_HEIGHT + 5);
    ...
    public void drawScreen(int mouseX, int mouseY, float par3) {
        ...
        fontRendererObj.drawString("URL", left + 10, top + 20, 0xff999999);
        fontRendererObj.drawString("Size", left + 10, top + 40, 0xff999999);
        fontRendererObj.drawString("x", left + 117, top + 40, 0xff999999);
        fontRendererObj.drawString("Turn On", left + 10, top + 60, 0xff999999);
        fontRendererObj.drawString("blocks away", left + 117, top + 60, 0xff999999);
        fontRendererObj.drawString("Turn Off", left + 10, top + 80, 0xff999999);
        fontRendererObj.drawString("blocks away", left + 117, top + 80, 0xff999999);
