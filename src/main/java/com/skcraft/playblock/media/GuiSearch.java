...
public class GuiSearch extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(searchButton = new GuiButton(0, left + 179, top + 14, 43, 20, "Search"));

        queryField = new GuiTextField(27, fontRendererObj, left + 38, top + 19, 150, fontRendererObj.FONT_HEIGHT + 5);
